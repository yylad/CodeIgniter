...
if ( ! function_exists('standard_date')) {
     ...
     * @return	string
     */
    public function standard_date($fmt = 'DATE_RFC822', $time = NULL)
    {
        if (empty($time)) {
            $time = now();
        }
...
if ( ! function_exists('timespan')) {
     ...
     * @return	string
     */
    public function timespan($seconds = 1, $time = '', $units = 7)
    {
        $CI =& get_instance();
        $CI->lang->load('date');
...
if ( ! function_exists('timezone_menu')) {
     ...
     * @return	string
     */
    public function timezone_menu($default = 'UTC', $class = '', $name = 'timezones', $attributes = '')
    {
        $CI =& get_instance();
        $CI->lang->load('date');
